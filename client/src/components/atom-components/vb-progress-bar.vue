<template>
  <div class="progress-bar" id="vbProgressBar">
    ...
    <div
      ...
      :class="{
        'left-border': falseProgress >= 0 && progress == 0,
        'right-border': falseProgress >= 0 && remained == 0,
      }"
...
.progress-bar {
  ...
  &-falseProgress {
    ...
    display: inline-block;
    height: var(--height);
    background: repeating-linear-gradient(-90deg, var(--second-color) 0 50%, var(--color) 50% 100%);
